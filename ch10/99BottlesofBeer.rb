...
Take one down and pass it around, ' + english_number(bottles - 1) + ' bottles of beer on the wall.'
	bottles = (bottles - 1)
end
puts english_number(1) + ' bottle of beer on the wall, ' + english_number(1) + ' bottle of beer.
Take ' + english_number(1) + ' and pass it around, no more bottles of beer on the wall.'
puts 'No more bottles of beer on the wall, no more bottles of beer.
Go to the store and buy some more, ' + bottles.to_s + ' bottles of beer on the wall.'